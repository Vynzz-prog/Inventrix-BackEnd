...
public class JwtUtil {
    ...
    private Key getSigningKey() {
        byte[] keyBytes = SECRET_KEY.getBytes(); // 🔹 lebih simpel
    ...
    public Claims extractAllClaims(String token) {
        try {
            ...
            System.out.println("❌ Gagal parse token: " + e.getMessage());
            throw e;
        }
    }
    ...
    // 🔹 Validasi token (opsional tapi bagus untuk digunakan di filter)
